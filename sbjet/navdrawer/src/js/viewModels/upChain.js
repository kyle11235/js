...
define(['ojs/ojcore', 'knockout', 'jquery', 'my/session',  'ojs/ojbutton', 'ojs/ojtoolbar', 'ojs/ojinputtext',
    ...
    function (oj, ko, $, session) {
        ...
        function ViewModel() {
            ...
            self.placeholder = ko.observable('最多可上链 ' + session.pointsOffChain() + ' 积分');
            self.warning = ko.observable();
            self.disabled = ko.computed(function() {
                if(!self.points()){
                    self.warning('请输入要上链的积分数');
                    return true;
                }
                ...
                if(self.points() > session.pointsOffChain()){
            ...
            self.submit1 = function() {
                ...
                session.movePointsUpChain(parseInt(self.points()), function(){
